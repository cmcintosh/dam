...
/**
 * Defines a class to build a listing of File Extend entities.
 *
 * @ingroup file_extend
 */
class FileExtendViewsData extends EntityViewBuilder {
  ...
  public function view(EntityInterface $entity, $view_mode = 'full', $langcode = NULL) {
    ...
    $form = \Drupal::formBuilder()->getForm('Drupal\dam\Form\FileExtendForm', $entity );
    $build['preview'] = $form;
