...
/**
 * Defines a class to build a listing of File Directory entities.
 *
 * @ingroup file_directory
 */
class FileDirectoryViewsData extends EntityViewBuilder {
  ...
  public function view(EntityInterface $entity, $view_mode = 'full', $langcode = NULL) {
    ...
    $form = \Drupal::formBuilder()->getForm('Drupal\dam\Form\FileDirectoryForm', $entity );
    $build['preview'] = $form;
