...
/**
 * Defines a class to build a listing of File Label entities.
 *
 * @ingroup file_label
 */
class FileLabelViewsData extends EntityViewBuilder {
  ...
  public function view(EntityInterface $entity, $view_mode = 'full', $langcode = NULL) {
    ...
    $form = \Drupal::formBuilder()->getForm('Drupal\dam\Form\FileLabelForm', $entity );
    $build['preview'] = $form;
