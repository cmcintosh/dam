...
/**
 * Defines a class to build a listing of File Collection entities.
 *
 * @ingroup file_collection
 */
class FileCollectionViewsData extends EntityViewBuilder {
  ...
  public function view(EntityInterface $entity, $view_mode = 'full', $langcode = NULL) {
    ...
    $form = \Drupal::formBuilder()->getForm('Drupal\dam\Form\FileCollectionForm', $entity );
    $build['preview'] = $form;
