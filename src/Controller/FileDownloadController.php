 ...
 */
  public function download(Request $request, $scheme = 'dam', $filepath = NULL) {
    // Merge remaining path arguments into relative file path.
    $old_uri = $scheme . '://' . $filepath;
    $uri = str_replace(';', '/', $old_uri);
    if (file_stream_wrapper_valid_scheme($scheme) && file_exists($uri)) {
      ...
      if (count($headers)) {
        ...
        return new BinaryFileResponse($uri, 200, $headers, $scheme !== 'dam');
      }
      throw new AccessDeniedHttpException();
    }
